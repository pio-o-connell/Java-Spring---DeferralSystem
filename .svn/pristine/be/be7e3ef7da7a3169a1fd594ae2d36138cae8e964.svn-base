...
<form:form method="POST" action="addModuleDeferralPage1"
	...
	<div class="addModuleDeferralPositioning">
		<div class="addModuleDeferralText2">
			<form:label path="studentId">
				<font size="5">Enter Student ID</font>
			</form:label>
			...
			<font color="red">${message}</font> <input data-theme="b"
				type="submit" data-icon="check" value="Submit" />
		</div>
	</div>
